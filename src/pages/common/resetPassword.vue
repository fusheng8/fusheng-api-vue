...
import { sendResetPasswordCode } from '~/api/code.ts'
...
async function getCode() {
  ...
  try {
    ...
    await sendResetPasswordCode({ email: resetModel.email })
    reset()
    resume()
    ...
    <div class="login-content flex-center">
      <div class="ant-pro-form-login-main rounded">
        ...
        <div class="box-border flex min-h-[520px]">
          <div class="ant-pro-form-login-main-right px-5 w-[500px] flex-center flex-col relative z-11">
            <div class="text-center py-6 text-2xl">
              重置密码
            </div>
            <a-form ref="formRef" :model="resetModel">
              <a-form-item
                name="email" :rules="[
              ...
              >
                <a-input
                  v-model:value="resetModel.email" allow-clear
              ...
              >
                <a-input
                  v-model:value="resetModel.password" allow-clear
              ...
              >
                <a-input
                  v-model:value="resetModel.password1" allow-clear
